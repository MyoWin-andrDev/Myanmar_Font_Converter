package com.example.font_converter;
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if(checkedId == R.id.rb_uniToZaw){
                    Toast.makeText(MainActivity.this, "Unicode to Zawgyi Checked", Toast.LENGTH_SHORT).show();
                    et_input.setTypeface(uniFont);
                    et_output.setTypeface(zawFont);
                }else{
                    Toast.makeText(MainActivity.this, "Zawgyi to Unicode Checked", Toast.LENGTH_SHORT).show();
